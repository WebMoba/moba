<div class="container-fluid mt-5">
  <div class="card bg-white mx-5" style="width: 100%;" >
        <div class="row mb-4">
            <div class="col-md-4 col-sm-4 col-xs-4">
                <div class="footer-text pull-left">
                    <div class="d-flex">
                        <h1 style="color: #957bda"><img src="{{ asset('Imagenes/Logotipo_Moba.png') }}" class="navbar-img-left" alt="Logo Moba"></h1>
                    </div><br>
            ...
            <div class="col-md-2 col-sm-2 col-xs-2">
                ...
                <ul class="card-text">
                    ...
                    <a href="{{ url('documentos/mapaNavegacion.pdf')}}" download="MapaNavegacion.pdf" class="mapa"><i class="bi bi-crosshair"></i> Mapa de Navegacion</a>
                </ul>
            </div>
        </div>
        ...
        <div class="row" style="font-size:10px;">
            ...
            <div class="col-md-6 col-sm-6 col-xs-6">
            <div class="foot"> 
                <p>2024 &copy; Todos los derechos reservados.
