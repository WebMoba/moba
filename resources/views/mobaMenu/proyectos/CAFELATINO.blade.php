...
<body class="background-image">
    ...
    <div class="breadcrums">
        ...
        ['url' => route('mobaMenu.proyectos.CAFELATINO'), 'label' => 'CafeLatino'],]])
        </div>
...
<!--- final breaddrums-->
    ...
    <div class="content">
        ...
        <div class="title-container">
            <h1 class="big-title">CAFE</h1>
            <h1 class="big-title1">LATINO</h1>
        </div>
                    ...
                    <div id="carouselExample" class="carousel slide">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="{{ asset('Imagenes/imgproyectos/CAFELATINO1.jpg') }}" alt="PARAISO1"
                            ...
                            <div class="carousel-item">
                                <img src="{{ asset('Imagenes/imgproyectos/CAFELATINO4.jpg') }}" alt="ACERIAS"
                                    class="d-block w-100 carousel-img">
                            </div>
                        </div>
