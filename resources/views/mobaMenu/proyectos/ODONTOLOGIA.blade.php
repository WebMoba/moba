...
<body class="background-image">
    ...
    <div class="content">
        ...
        <div class="title-container">
            <h1 class="big-title">ODONTOLOGIA</h1>
            <h1 class="big-title1">LIZETH DORADO</h1>
        </div>
                    ...
                    <div id="carouselExample" class="carousel slide">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="{{ asset('Imagenes/imgproyectos/lizethdorado1.jpg') }}" alt="PARAISO1"
                                    class="d-block w-100 carousel-img">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('Imagenes/imgproyectos/lizethdorado2.jpg') }}" alt="JAATELO"
                                    class="d-block w-100 carousel-img">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('Imagenes/imgproyectos/lizethdorado3.jpg') }}" alt="ACERIAS"
                                    class="d-block w-100 carousel-img">
                            </div>
                        </div>
