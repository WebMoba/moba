...
<body class="background-image">
    ...
    <div class="breadcrums">
        ...
        ['url' => route('mobaMenu.proyectos.JOVEN'), 'label' => 'JovenPro'],]])
        </div>
...
<!--- final breaddrums-->
    ...
    <div class="content">
        ...
        <div class="title-container">
            <h1 class="big-title ">JOVEN PRO</h1>
        </div>
                    ...
                    <div id="carouselExample" class="carousel slide">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="{{ asset('Imagenes/imgproyectos/jovenpro1.jpg') }}" alt="PARAISO1"
                                    class="d-block w-100 carousel-img">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('Imagenes/imgproyectos/jovenpro2.jpg') }}" alt="JAATELO"
                                    class="d-block w-100 carousel-img">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('Imagenes/imgproyectos/jovenpro3.jpg') }}" alt="ACERIAS"
                                    class="d-block w-100 carousel-img">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('Imagenes/imgproyectos/jovenpro4.jpg') }}" alt="ACERIAS"
                                    class="d-block w-100 carousel-img">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('Imagenes/imgproyectos/jovenpro5.jpg') }}" alt="ACERIAS"
                                    class="d-block w-100 carousel-img">
                            </div>
                        </div>
