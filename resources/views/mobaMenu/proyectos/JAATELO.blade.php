...
<body class="background-image">
    ...
    <div class="breadcrums">
        ...
        ['url' => route('mobaMenu.proyectos.JAATELO'), 'label' => 'Jaatelo'],]])
        </div>
...
<!--- final breaddrums-->
    ...
    <div class="content">
        ...
        <div class="title-container">
            <h1 class="big-title">HELADERIA</h1>
            <h1 class="big-title1">JAATELO</h1>
        </div>
                    ...
                    <div id="carouselExample" class="carousel slide">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="{{ asset('Imagenes/imgproyectos/jaatelo1.JPG') }}" alt="PARAISO1"
                                    class="d-block w-100 carousel-img">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('Imagenes/imgproyectos/JAATELO2.JPG') }}" alt="JAATELO"
                                    class="d-block w-100 carousel-img">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('Imagenes/imgproyectos/JAATELO3.JPG') }}" alt="ACERIAS"
                                    class="d-block w-100 carousel-img">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('Imagenes/imgproyectos/JAATELO4.JPG') }}" alt="ACERIAS"
                                    class="d-block w-100 carousel-img">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('Imagenes/imgproyectos/JAATELO5.JPG') }}" alt="ACERIAS"
                                    class="d-block w-100 carousel-img">
                            </div>
                        </div>
