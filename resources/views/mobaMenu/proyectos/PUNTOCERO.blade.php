...
<!--- final breaddrums-->
    ...
    <div class="content">
        ...
        <div class="title-container">
            <h1 class="big-title">COMIDAS RAPIDAS</h1>
            <h1 class="big-title1">PUNTO CERO</h1>
        </div>
                ...
                <div class="col-md-6">
                    <div class="titulo mt-4 mb-4">
                        <p>Somos una empresa dedicada a satisfacer las necesidades de nuestros clientes, principalmente
                            ...
                            comunidad.omos una empresa dedicada a satisfacer las necesidades de nuestros clientes,
                            principalmente
                            en frutas, verduras y demás productos de la canasta familiar; vinculando como aliados
                            estratégicos a proveedores; ofreciendo condiciones dignas de trabajo a personal idóneo que
                            vive y aplica principios de integridad, honestidad y constancia, garantizando la retribución
                    ...
                    <div id="carouselExample" class="carousel slide">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="{{ asset('Imagenes/imgproyectos/puntocero1.jpg') }}" alt="PARAISO1"
                                    class="d-block w-100 carousel-img">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('Imagenes/imgproyectos/puntocero2.jpg') }}" alt="JAATELO"
                                    class="d-block w-100 carousel-img">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('Imagenes/imgproyectos/puntocero3.jpg') }}" alt="ACERIAS"
                                    class="d-block w-100 carousel-img">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('Imagenes/imgproyectos/puntocero4.jpg') }}" alt="ACERIAS"
                                    class="d-block w-100 carousel-img">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('Imagenes/imgproyectos/puntocero5.jpg') }}" alt="ACERIAS"
                                    class="d-block w-100 carousel-img">
                            </div>
                        </div>
