...
<body class="background-image">
    ...
    <div class="breadcrums">
        ...
        ['url' => route('mobaMenu.proyectos.EMPANADASRANCHO'), 'label' => 'Empanadas Rancho'],]])
        </div>
                    ...
                    <div id="carouselExample" class="carousel slide">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="{{ asset('Imagenes/imgproyectos/EMPANADASRANCHO1.jpg') }}" alt="PARAISO1"
                                    class="d-block w-100 carousel-img">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('Imagenes/imgproyectos/EMPANADASRANCHO2.jpg') }}" alt="JAATELO"
                                    class="d-block w-100 carousel-img">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('Imagenes/imgproyectos/EMPANADASRANCHO3.jpg') }}" alt="ACERIAS"
                                    class="d-block w-100 carousel-img">
                            </div>
                        </div>
