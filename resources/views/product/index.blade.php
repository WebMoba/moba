                                ...
                                <tbody>
                                    @foreach ($products as $product)
                                        <tr>
											...
											<td>{{ $product->name }}</td>
											<td><img src="{{ asset('storage/' . $product->image) }}" width="150" height="150"></td>
                                            ...
                                            <td>
                                                <form action="{{ route('product.destroy',$product->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('product.show',$product->id) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Mostrar') }}</a>
